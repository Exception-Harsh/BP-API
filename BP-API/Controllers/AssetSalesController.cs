...
//        public HttpResponseMessage GetAssetSalesData(string projectNumber, string yearMonth, string buildingName)
//        {
//            try
//            {
...
//            ASM_RCVD_STMP_DTY_AMNT_N, ASM_RCVD_RGSTRN_AMNT_N, ASM_RCVD_OC_AMNT_N, ASM_RCVD_PSS_THRGH_CHRGS_N,
//            ASM_RCVD_TXS_AMNT_N, ASM_RCVD_TTL_AMNT_N, ASM_MD_OF_FNNC_C, ASM_FI_NM_V, ASM_PYMNT_PLN_NM_V,
//            ASM_SRC_OF_CSTMR_C, ASM_CHNNL_PRTNR_NM_V, ASM_CHNNL_PRTNR_MBL_V, ASM_CHNNL_PRTNR_EML_V,
//            ASM_BRKRG_AMNT_N";
...
//                        adapter.UpdateCommand.Parameters.Add(new OracleParameter("SoldFlat", OracleDbType.Varchar2, 50, ParameterDirection.Input, true, 0, 0, "ASM_UNT_SLD_FLG_C", DataRowVersion.Current, DBNull.Value));
